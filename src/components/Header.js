...
const Header = () => {
    ...
    return (<header>
        <Navbar className='brand_body' bg="dark" variant="dark" expand="lg" collapseOnSelect>
            <Container >
                <LinkContainer to='/'>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav className="ms-auto">
                        <LinkContainer to='/cart'>
                            <Nav.Link className="nav_cart"  ><i className='fas fa-shopping-cart'></i> Cart {cartItems.length !== 0 && `(${cartItems.length})`}</Nav.Link>
                        </LinkContainer>
                        {userInfo ? (
